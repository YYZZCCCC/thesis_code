##Table 3. Distribution of Vitamin D Levels by Sleep Duration.(Female)
...
cat("Vitamin D Levels by Sleep Duration (Females Only):\n")
...
cat("\nOdds Ratio Comparisons (Females Only):\n")
